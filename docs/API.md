...
| `caveats` | string[] | Per-span warnings, always including the universal temporary-signage caveat. Every entry is a sentence — leading capital, closing full stop — so it can be printed verbatim in a list. |
